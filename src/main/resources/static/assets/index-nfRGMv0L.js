...
let D;
const N = () => D || (D = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof global ? global : {});

function P(e) {
    if (d(e)) {
        const t = {};
        for (let n = 0; n < e.length; n++) {
            const s = e[n], o = h(s) ? L(s) : P(s);
...
const Ue = new Ne, je = new Pe, Fe = new Ne(!0), Le = e => e, Ve = e => Reflect.getPrototypeOf(e);
...
function Ct(e) {
    if (!(1 & e.flags)) {
        const t = Nt(e), n = wt[wt.length - 1];
        !n || !(2 & e.flags) && t >= Nt(n) ? wt.push(e) : wt.splice(function (e) {
            let t = xt + 1, n = wt.length;
            for (; t < n;) {
                const s = t + n >>> 1, o = wt[s], r = Nt(o);
...
function Ot(e, t, n = xt + 1) {
    for (; n < wt.length; n++) {
        ...
        if (t && 2 & t.flags) {
            ...
            wt.splice(n, 1), n--, 4 & t.flags && (t.flags &= -2), t(), 4 & t.flags || (t.flags &= -2)
        }
    }
}
...
function Dt(e) {
    if (St.length) {
        const e = [...new Set(St)].sort((e, t) => Nt(e) - Nt(t));
...
const Nt = e => null == e.id ? 2 & e.flags ? -1 : 1 / 0 : e.id;
...
function Pt(e) {
    try {
        ...
        xt = -1, wt.length = 0, Dt(), Rt = null, (wt.length || St.length) && Pt()
    }
}
...
function gn(e) {
    ...
    if (f && mn(f, e, "c"), P(Kt, h), P(zt, v), P(en, m), P(tn, y), P(Xt, _), P(Jt, b), P(cn, R), P(ln, k), P(rn, T), P(nn, w), P(sn, S), P(on, I), d(C)) if (C.length) {
...
const On = {}, Dn = () => Object.create(On), Nn = e => Object.getPrototypeOf(e) === On;
...
const $n = e => "_" === e || "__" === e || "_ctx" === e || "$stable" === e, Bn = e => d(e) ? e.map(Ps) : [Ps(e)],
    Wn = (e, t, n) => {
        if (t._n) return t;
...
function Gn(e) {
    return function (e) {
        ...
        const {
            ...
            "svg" === t.type ? i = "svg" : "math" === t.type && (i = "mathml"), null == e ? I(t, n, s, o, r, i, l, c) : P(e, t, o, r, i, l, c)
        }, I = (e, t, n, s, r, c, a, u) => {
            let d, f;
            ...
            for (; u <= f && u <= p;) {
                const n = e[u], o = t[u] = a ? Us(t[u]) : Ps(t[u]);
                if (!Ts(n, o)) break;
                _(n, o, s, null, r, i, l, c, a), u++
            }
            for (; u <= f && u <= p;) {
                const n = e[f], o = t[p] = a ? Us(t[p]) : Ps(t[p]);
                if (!Ts(n, o)) break;
            ...
            if (u > f) {
                if (u <= p) {
                    ...
                    for (; u <= p;) _(null, t[u] = a ? Us(t[u]) : Ps(t[u]), s, n, r, i, l, c, a), u++
                }
            } else if (u > p) for (; u <= f;) Y(e[u], r, i, !0), u++; else {
                const h = u, v = u, g = new Map;
                for (u = v; u <= p; u++) {
                    const e = t[u] = a ? Us(t[u]) : Ps(t[u]);
...
function us(e) {
    ...
    try {
        if (4 & n.shapeFlag) {
            const e = o || s, t = e;
            y = Ps(u.call(t, e, d, f, h, p, v)), _ = c
        } else {
            const e = t;
            0, y = Ps(e.length > 1 ? e(f, {attrs: c, slots: l, emit: a}) : e(f, null)), _ = t.props ? c : ds(c)
        }
    } catch (A) {
...
const Ms = function (e, t = null, n = null, s = 0, o = null, r = !1) {
    ...
    if (t) {
        t = function (e) {
            return e ? ot(e) || Nn(e) ? l({}, e) : e : null
        }(t);
        let {class: e, style: n} = t;
        e && !h(e) && (t.class = V(e)), g(n) && (ot(n) && !d(n) && (n = l({}, n)), t.style = P(n))
    }
...
function Os(e, t, n = !1, s = !1) {
    const {props: o, ref: i, patchFlag: l, children: c, transition: a} = e, u = t ? function (...e) {
        ...
        for (let n = 0; n < e.length; n++) {
            const s = e[n];
            for (const e in s) if ("class" === e) t.class !== s.class && (t.class = V([t.class, s.class])); else if ("style" === e) t.style = P([t.style, s.style]); else if (r(e)) {
                const n = t[e], o = s[e];
...
function js(e, t) {
    ...
    if (null == t) t = null; else if (d(t)) n = 16; else if ("object" == typeof t) {
        ...
        }
        {
            n = 32;
            const s = t._;
            s || Nn(t) ? 3 === s && Ut && (1 === Ut.slots._ ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024)) : t._ctx = Ut
        }
...
const No = {randomUUID: "undefined" != typeof crypto && crypto.randomUUID && crypto.randomUUID.bind(crypto)};

function Po(e, t, n) {
    if (No.randomUUID && !e) return No.randomUUID();
...
function gr(e) {
    const t = async e => {
        ...
        const n = hr(t);
        e.sendAudioData({action: "AUDIO_RENDER", body: n, requestId: Po()})
    };
    return {
        playAudio: async () => {
            try {
            ...
            }("16k.pcm"), n = 2048, s = Math.ceil(t.byteLength / n), o = Po();
            for (let r = 0; r < s; ++r) {
...
function mr(e) {
    ...
    const i = () => {
        o = new WebSocket(e), o.onopen = () => {
            ...
            n.value = !1, r < 100 ? (r++, setTimeout(i, 0)) : s.value = "无法连接到消息服务，请刷新页面重试"
        }, o.onerror = e => {
...
((...e) => {
    ...
    name: "App", setup() {
        var e;
        const t = at(!1), n = at(!1), s = at(!1), o = at(Po()), r = at(!1), i = at(!1), l = at(!1), c = at(!0),
            a = at("i-ritjz60ax9sbk/04e4ed69c50986c9b95f006f0c23505fa95d97ddefc40f80d7ca72544d23217c/2026-02-15T02:03:26.334Z");
        ...
        const {playAudio: h, playStreamAudio: v} = gr(_r),
            g = at(`${p.value}?token=${a.value}&initMode=${u.value}&cameraId=1&figureId=${d.value}&backgroundImageUrl=${f.value}\n            `),
            m = e => {
                if ("https://open.xiling.baidu.com" === e.origin) {
                    ...
                    switch (r) {
                        ...
                        case"msg":
                            ...
                            r === o.value && "FINISHED" === e ? Po() : "DISCONNECT_ALERT" === e && (i.value = !0)
                    }
                }
            }, y = () => {
            ...
            b = `ws://${null == (e = window.document.location.origin.split("//")) ? void 0 : e[1].split(":")[0]}:9001/ws`, {
                messages: A,
                isConnected: w
            } = mr(b);
        return ns(A, (e, t) => {
            e && _r.sendMessage({
                ...
                body: JSON.stringify({first: e.first, last: e.last, text: e.message}),
                requestId: o.value
            })
        }), ns(w, (e, t) => {
            e || _r.sendMessage({action: "TEXT_RENDER", body: "<interrupt></interrupt>", requestId: o.value})
        }), ns([t, n, r, s], ([e, t, n, s]) => {
    ...
    return As(), Es("div", xr, [s.showHuman ? (As(), Es("div", Sr, [Cs("iframe", {
        ...
        src: s.iframeSrc,
        style: P(s.iframeStyle),
        allow: "microphone;camera;midi;encrypted-media;autoplay;"
    }, null, 12, Er)])) : Ns("", !0), t[0] || (t[0] = Cs("div", {class: "button-wrapper"}, null, -1))])
}], ["__scopeId", "data-v-c0e22007"]])).mount("#app");
